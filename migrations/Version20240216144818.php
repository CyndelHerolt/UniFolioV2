 ...
 */
final class Version20240216144818 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE annee (id INT NOT NULL, libelle VARCHAR(255) NOT NULL, ordre INT NOT NULL, libelle_long VARCHAR(255) NOT NULL, opt_alternance TINYINT(1) NOT NULL, actif TINYINT(1) NOT NULL, diplome_id INT NOT NULL, INDEX IDX_DE92C5CF26F859E2 (diplome_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8');
        ...
        $this->addSql('CREATE TABLE apc_apprentissage_critique (id INT NOT NULL, libelle LONGTEXT NOT NULL, code VARCHAR(20) NOT NULL, apc_niveau_id INT DEFAULT NULL, INDEX IDX_A99B947A9445617E (apc_niveau_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE apc_competence (id INT NOT NULL, libelle VARCHAR(255) NOT NULL, nom_court VARCHAR(50) NOT NULL, couleur VARCHAR(20) NOT NULL, code VARCHAR(20) NOT NULL, ue VARCHAR(20) NOT NULL, apc_referentiel_id INT NOT NULL, INDEX IDX_B949FC0F9048A9AB (apc_referentiel_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE apc_niveau (id INT NOT NULL, libelle VARCHAR(255) NOT NULL, ordre INT NOT NULL, annee_id INT NOT NULL, apc_competence_id INT NOT NULL, INDEX IDX_5CE8A823543EC5F0 (annee_id), INDEX IDX_5CE8A823DA14D531 (apc_competence_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8');
        ...
        $this->addSql('CREATE TABLE apc_parcours (id INT NOT NULL, libelle VARCHAR(255) NOT NULL, code VARCHAR(10) NOT NULL, actif TINYINT(1) NOT NULL, formation_continue TINYINT(1) NOT NULL, apc_referentiel_id INT NOT NULL, INDEX IDX_5DA884A59048A9AB (apc_referentiel_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE apc_referentiel (id INT NOT NULL, libelle VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, annee_publication INT NOT NULL, departement_id INT NOT NULL, INDEX IDX_E744CC81CCF9E01E (departement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8');
        ...
        $this->addSql('CREATE TABLE departement (id INT NOT NULL, libelle VARCHAR(255) NOT NULL, logo_name VARCHAR(50) DEFAULT NULL, couleur VARCHAR(16) DEFAULT NULL, description LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8');
        ...
        $this->addSql('CREATE TABLE diplome (id INT NOT NULL, libelle VARCHAR(255) NOT NULL, sigle VARCHAR(40) NOT NULL, departement_id INT NOT NULL, apc_parcours_id INT DEFAULT NULL, INDEX IDX_EB4C4D4ECCF9E01E (departement_id), INDEX IDX_EB4C4D4E3E102C73 (apc_parcours_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE enseignant (id INT AUTO_INCREMENT NOT NULL, prenom VARCHAR(50) NOT NULL, nom VARCHAR(50) NOT NULL, mail_perso VARCHAR(255) DEFAULT NULL, mail_univ VARCHAR(255) NOT NULL, username VARCHAR(75) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8');
        ...
        $this->addSql('CREATE TABLE groupe (id INT NOT NULL, libelle VARCHAR(255) NOT NULL, code_apogee VARCHAR(50) NOT NULL, ordre INT NOT NULL, type_groupe_id INT NOT NULL, apc_parcours_id INT DEFAULT NULL, INDEX IDX_4B98C21CE83749C (type_groupe_id), INDEX IDX_4B98C213E102C73 (apc_parcours_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE semestre (id INT NOT NULL, libelle VARCHAR(255) NOT NULL, ordre_annee INT NOT NULL, actif TINYINT(1) NOT NULL, ordre_lmd INT NOT NULL, code_element VARCHAR(20) NOT NULL, annee_id INT NOT NULL, INDEX IDX_71688FBC543EC5F0 (annee_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE type_groupe (id INT NOT NULL, libelle VARCHAR(50) NOT NULL, mutualise TINYINT(1) NOT NULL, ordre_semestre INT NOT NULL, type VARCHAR(2) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8');
